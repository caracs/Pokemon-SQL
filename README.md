...
A relational-database and SQL project that focuses on Pokémon data.  
This repository presents SQL schema definitions, data insertion scripts, query exercises and an interactive Jupyter notebook to practice and validate SQL queries on a Pokémon-themed dataset.
...
Design a relational schema from a domain (Pokémon universe).
Populate tables with representative data.
Write and test SQL queries of increasing complexity.
Learn query optimization techniques.
Use interactive tools (notebook + SQL) to explore data and validate results.
